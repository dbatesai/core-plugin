...
**The control-surface rule — every PROJECT.md write is edit-gated (spec §7).** Before any render (Step 2.4), hot-section (Step 2.6), or §Moves/§State mutation (Steps 3.1–3.3), run the executable lifecycle detector (Hale's 2026-07-22 boundary fix), which classifies PROJECT.md and every unit against the last CORE baseline:
